...
# 1. 词法分析演示
uv run python main.py --lexer test_cases/test_01_basic.sy     # 正常词法
uv run python main.py --lexer test_cases/test_09_lex_error.sy  # Error type A

# 2. 语法分析演示
uv run python main.py --parser test_cases/test_01_basic.sy     # AST输出
uv run python main.py --parser test_cases/test_10_syntax_error.sy # Error type B

# 3. 语义分析演示
uv run python main.py --semantic test_cases/test_01_basic.sy   # success
uv run python main.py --semantic test_cases/test_11_semantic_error.sy # 7种错误
